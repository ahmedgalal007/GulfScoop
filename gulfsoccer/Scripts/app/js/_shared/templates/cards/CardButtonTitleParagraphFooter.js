...
define(["require", "exports", "_shared/templates/Abstract"], function (require, exports, Abstract_1) {
    ...
    // < !--Card -->
    //
    var CardButtonTitleParagraphFooter = /** @class */ (function (_super) {
        __extends(CardButtonTitleParagraphFooter, _super);
        function CardButtonTitleParagraphFooter() {
        ...
        // };
        CardButtonTitleParagraphFooter.prototype.createCard = function (d) {
            this.cardElem = $('<div/>');
        ...
        return CardButtonTitleParagraphFooter;
    }(Abstract_1.BaseCard));
