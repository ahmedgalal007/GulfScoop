...
define(["require", "exports", "_shared/templates/Abstract"], function (require, exports, Abstract_1) {
    ...
    // <!--Card Light-- >
    //
    var CardTitleParagraphReadmore = /** @class */ (function (_super) {
        __extends(CardTitleParagraphReadmore, _super);
        function CardTitleParagraphReadmore() {
        ...
        // };
        CardTitleParagraphReadmore.prototype.createCard = function (d) {
            this.cardElem = $('<div/>');
        ...
        return CardTitleParagraphReadmore;
    }(Abstract_1.BaseCard));
